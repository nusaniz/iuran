...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        // echo "<td> <a href='delete_booking.php?id=" . $row["user_id"] . "' class='btn btn-danger btn-sm'>Hapus</a> | <a href='index.php?page=edituser&&id=" . $row["user_id"] . "' class='btn btn-primary btn-sm'> Edit</a></td>";
        echo "<td> <a href='index.php?page=edituser&&id=" . $row["user_id"] . "' class='btn btn-primary btn-sm'> Edit</a> | <a href='delete_booking.php?id=" . $row["user_id"] . "' class='btn btn-danger btn-sm'>Hapus</a></td>";
